...
def getLLMResponse(form_input,age_option,tasktype_option):
    ...
    prefix = """you are a {template_ageoption}, and you are a {template_tasktype_option}: 
    Here are some examples:
    """

    suffix = """Question: {template_userInput}
    Response:"""
...
# UI here...
st.set_page_config(
    page_title="Marketing Campaign App",
    page_icon="📈",
    layout="centered",
...
st.write(
    "This is a simple app to help you with your marketing campaign. You can ask me anything about marketing campaigns, and I will try to help you."
)

input = st.text_area(
    "What do you want to know about marketing campaigns?",
    placeholder="Ask me anything about marketing campaigns...",
    height=200,
)

tasktype_options = st.selectbox(
    "What type of task do you want to perform?",
    ("Marketing Campaign", "Marketing Strategy", "Marketing Plan","writing a product discription"), key=1
)

age_option = st.selectbox(
    "select the age group",
    ("Kids", "Teens", "Adults", "Elders"), key=2
)
...
if submit:
    st.write(getLLMResponse(input, age_option, tasktype_options))
